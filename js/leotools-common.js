...
function Leotools(args)
{
	...
	this.cors_proxy = ( typeof args.cors_proxy !== 'undefined') ? args.cors_proxy : 'http://code.pachogrande.com/leotools/cors/proxy.php/';
	this.district = ( typeof args.district !== 'undefined') ? args.district : '96';
	this.tm_year = ( typeof args.tm_year !== 'undefined') ? args.tm_year : '2017-2018';
